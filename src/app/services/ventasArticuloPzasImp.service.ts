...
@Injectable()
export class ServicioVentasArticuloPzasImp{
    public API: string;
...
Get(FiltrosVentasArticulo: any): Observable<any>{
    ...
    let headers =  new HttpHeaders().set('Content-Type','application-json')
                                    ...
                                    return this._http.get(this.API_URL+this.API + 'reportes/VentasArticuloPzasImpo.php?'+this.sFiltros,{headers:headers});
