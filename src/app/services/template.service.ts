...
console.log("Llamada");
   ...
   return this._http.get("https://www.fonelli.com/med_fonelli_apiportal/catalogos/template.php",{headers:headers});
}
...
Update(Datos: FormData): Observable<any>{
     ...
     //return this._http.post('https://www.fonelli.com/med_fonelli_apiportal/catalogos/template.php',Datos);
}
